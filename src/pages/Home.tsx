        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-16 md:grid-cols-2 md:py-24 lg:py-32">
          ...
          <div className="order-1 flex justify-center md:order-2">
            <div className="relative">
              <div className="h-72 w-72 rounded-[2rem] bg-gradient-to-br from-zinc-100 to-zinc-50 overflow-hidden shadow-2xl shadow-zinc-200/60 sm:h-96 sm:w-96 animate-[float_4s_ease-in-out_infinite]">
                <img src="/images/product-1.jpg" alt="Chargly Power Bank" className="h-full w-full object-cover" />
              </div>
      ...
      <section className="bg-zinc-900 py-20">
        <div className="mx-auto max-w-4xl px-5">
          <div className="text-center mb-10">
            <p className="text-xs font-semibold uppercase tracking-widest text-accent-400 mb-2">Míralo en acción</p>
            <h2 className="text-3xl font-bold text-white sm:text-4xl">Un poder que se siente</h2>
          </div>
